...
if __name__ == "__main__":
    ...
    for idx, target_dir in enumerate(dirs):
        ...
        print("============== MODEL LOAD ==============")
        # set model path
        model_file = "{model}/model_VAE_machineId2_{machine_type}.pth".format(model=param["model_directory"],
        ...
        if not os.path.exists(model_file):
            ...
            sys.exit(-1)
        model = VAE(device, x_dim=param["VAE"]["x_dim"], h_dim=param["VAE"]["h_dim"], z_dim=param["VAE"]["z_dim"]).to(device)
