...
DATA_ROOT = Path('/teamspace/studios/this_studio/SoundDataset/dev_data/dev_data') # set your data folder here
SAVE_TO = Path('/teamspace/studios/this_studio/SoundDataset/dev_data/dev_data')
